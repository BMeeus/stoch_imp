...
driven finite state stochastic system fulfilling detailed balance. It includes several classes for handling  the
:math:`W` matrix and related transition matrices. It also includes some functionality to ease plotting with Matplotlib.
